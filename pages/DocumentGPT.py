...
Upload your file in the side bar
""")

with st.sidebar:
    file = st.file_uploader("Upload a .txt .pdf of .docx file", type=["pdf", "txt", "docx"])
...
if file:
    ...
    paint_history()
    message = st.chat_input("Send message to AI, whatever you have question about the file")
    if message:
